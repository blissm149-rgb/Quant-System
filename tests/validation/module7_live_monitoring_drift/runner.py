"""Module 7 runner: Live Monitoring & Drift validation suite.

Collects all Module 7 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module7_live_monitoring_drift.runner
"""
...
MODULE_NAME = "module7_live_monitoring_drift"
...
TEST_FILES = [
    ...
    "test_signal_decay_lifecycle.py",
    "test_reconciliation_drift.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 7 tests via pytest."""
