"""Module 5 runner: Risk & Stress Testing validation suite.

Collects all Module 5 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module5_risk_stress.runner
"""
...
MODULE_NAME = "module5_risk_stress"

TEST_FILES = [
    "test_stress_test_scenarios.py",
    "test_drawdown_monitoring.py",
    "test_exposure_limits.py",
    "test_risk_decomposition_validation.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 5 tests via pytest."""
