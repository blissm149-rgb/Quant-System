"""Module 8 runner: ML Code Audit validation suite.

Collects all Module 8 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module8_ml_audit.runner
"""
...
MODULE_NAME = "module8_ml_audit"

TEST_FILES = [
    "test_ml_code_audit.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 8 tests via pytest.
