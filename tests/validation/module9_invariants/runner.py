"""Module 9 runner: Cross-Cutting Module Invariant validation suite.

Collects all Module 9 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module9_invariants.runner
"""
...
MODULE_NAME = "module9_invariants"

TEST_FILES = [
    "test_module_invariants.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 9 tests via pytest.
