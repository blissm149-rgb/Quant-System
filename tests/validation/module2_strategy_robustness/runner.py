"""Module 2 runner: Strategy Robustness validation suite.

Collects all Module 2 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module2_strategy_robustness.runner
"""
...
MODULE_NAME = "module2_strategy_robustness"

TEST_FILES = [
    "test_parameter_sensitivity.py",
    "test_signal_decay_and_turnover.py",
    "test_overfitting_detection.py",
    "test_cross_validation_stability.py",
    "test_constraint_robustness.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 2 tests via pytest."""
