"""Module 6 runner: Monte Carlo & Statistical validation suite.

Collects all Module 6 tests and produces a JSON/CSV report.
Can be run standalone: python -m tests.validation.module6_monte_carlo_statistical.runner
"""
...
MODULE_NAME = "module6_monte_carlo_statistical"

TEST_FILES = [
    "test_bootstrap_confidence.py",
    "test_deflated_sharpe.py",
    "test_multiple_hypothesis.py",
    "test_monte_carlo_robustness.py",
]


def run_module(verbose: bool = True, report: bool = True) -> int:
    """Run all Module 6 tests via pytest."""
